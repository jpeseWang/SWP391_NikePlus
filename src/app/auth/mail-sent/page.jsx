...
export default function ForgotPasswordPage() {
  ...
  const receivedEmail = params.get("receivedEmail");
    ...
    <>
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <h3 className="mt-2 text-center text-base leading-6 tracking-tight">
            Password recovery link has been sent to {receivedEmail}!
          </h3>
          <img
            alt=""
            loading="lazy"
            ...
            height={427}
            decoding="async"
            className="mx-auto mt-7 h-16 w-auto"
            src="/mail.png"
          ></img>
