...
export default function Banner({ sessionData }) {
    ...
    return (
        <div className="mt-9 relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
            <div
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                ...
                {isAuthenticated ?
                    <p className="text-sm leading-6 text-gray-900">
                        ...
                        <strong className="font-semibold">{sessionData?.data.user?.name}!</strong>
